"""
Django settings for soudruh project.
...
SECRET_KEY = 'django-insecure-_h$i!(xws05r0n(zav1*f%qfhse#l@+^)3w*u7=(ghe=-9jp=_'
...
WSGI_APPLICATION = 'soudruh.wsgi.application'
